...
The information required to communicate with the device's OTEL Collector is injected into each container using [environment variables](../device-interoperability/collecting-workload-observability-data.md#connecting-to-the-opentelemetry-collector).
...
> **Note:** See the [workload observability overview](../margo-overview/workload-observability-overview.md) page for more information about workload observablity.
>
