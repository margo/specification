...
Validity-period evaluation depends on a trustworthy local clock (see [unreliable validator clock](identity-security-considerations.md#framework-threats)). A verifier MAY apply a small, bounded clock-skew tolerance consistent with its time-synchronization assumptions.
