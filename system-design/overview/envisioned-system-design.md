...
Workloads are the software deployed to Margo-compliant edge compute devices. See the [workloads overview](workloads.md) page to learn more Margo's supported workloads and how the are packaged.
