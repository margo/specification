...
![(Multiple Personas - Device Supplier and Platform Supplier)](../figures/multiple-personas-device-platform.drawio.svg)
...
![Multiple Personas - OT User and Workload Supplier](../figures/multiple-personas-ot-user-workload.drawio.svg)
